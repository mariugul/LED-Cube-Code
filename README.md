...
## Previous Version
The first version of the LED cube code was written entirely on Arduino. This code uses lots of nested `for()` and `while()` loops and `delay()`. It's simple and it does work. The code, corresponding code generator and instructions can be found at [Instrucatbles](https://www.instructables.com/id/LED-CUBE-CODE-4x4x4-Arduino/). Who wrote the Arduino code is not known to me, however I made the code generator application.
